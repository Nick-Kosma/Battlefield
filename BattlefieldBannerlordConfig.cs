...
{
    public static class BattlefieldBannerlordConfig
    {
        ...
        private sealed class ConfigPropertyInt : ConfigProperty
        {
            ...
            public bool IsValidValue(int value)
            {
                ...
                foreach (int possibleValue in _possibleValues)
                {
        ...
        {
            get => _numberOfCorpses;
            set => _numberOfCorpses = value;
        }
        ...
        public static int AutoSaveInterval
        {
            ...
            set => _autoSaveInterval = value == 4 ? -1 : value;
        }
        ...
        {
            get => _stopGameOnFocusLost;
            set => _stopGameOnFocusLost = value;
        }
        ...
        {
            get => _orderLayoutType;
            set => _orderLayoutType = value;
        }
        ...
        public static void Initialize()
        {
            ...
            else
            {
                ...
                // Mock the ValidateOptions method since IMBBannerlordConfig is not found
                ValidateOptions();
            }
        ...
        private static void ValidateOptions()
        {
            ...
            // Since IMBBannerlordConfig is not found, we mock this method
        }
